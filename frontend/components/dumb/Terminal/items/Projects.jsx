...
const Project = ({project, onImageClick}) => {
	...
	return (
		<div className='row-block'>
			...
			<article className='flex-row'>
				<div className='cell sm sub-title'>Github Repo:</div>
			...
			{project.liveurl &&
				<article className='flex-row'>
					<div className='cell sm sub-title'>Live Website:</div>
					<div className='cell fill'>
			...
			<article className='flex-row'>
				<div className='cell sm sub-title'>Tech:</div>
				{topicList}
			</article>

			<article className='flex-row'>
				<div className='cell sm sub-title'>Languages:</div>
				{langList}
			</article>
