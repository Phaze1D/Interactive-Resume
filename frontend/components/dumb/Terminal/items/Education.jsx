...
const School = ({school}) => (
	<div className='row-block'>
		...
		<article className='flex-row'>
			<div className='cell sm title'>Degree:</div>
			<div className='cell fill'>{school.degree}</div>
		</article>

		{school.majors &&
			<article className='flex-row'>
				<div className='cell sm title'>Major:</div>
...
const Online = ({online, onImageClick}) => (
	<div className='row-block'>
		{online.images &&
			<article className='flex-row'>
				<div className='cell sm title'></div>
				<div className='cell fill'>
		...
		<article className='flex-row'>
			<div className='cell sm title'>Course:</div>
			<div className='cell fill'>{online.name}</div>
		</article>

		<article className='flex-row'>
			<div className='cell sm title'>School:</div>
